...
fun HabitEdit(
    ...
    val habitName: MutableState<String> = remember{ mutableStateOf(currentHabit.name) }
    val isReminderActive: MutableState<Boolean> = remember{ mutableStateOf(currentHabit.reminder.isActive) }
    val reminderHours: MutableState<Int> = remember{ mutableIntStateOf(currentHabit.reminder.hour) }
    val reminderMinutes: MutableState<Int> = remember{ mutableIntStateOf(currentHabit.reminder.minute) }
